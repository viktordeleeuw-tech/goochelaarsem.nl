# AGENTS.md – LionCraft Client Website Project
...
### Skills die Codex gebruikt
Voor dit project laadt Codex automatisch:
...
**Hoe Codex deze gebruikt:**
- CTO-context voor technical decisions
- CMO-context voor brand/messaging questions
- Als Viktor vraagt om een "spec" → Codex raadpleegt Development specs uit Obsidian
